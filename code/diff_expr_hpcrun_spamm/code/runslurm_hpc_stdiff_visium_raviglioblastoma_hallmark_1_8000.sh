...
#SBATCH --output=/home/hpc_user/spatialge_stdiff_manuscript/stdiff_hpcrun_spamm/code/logs/output_hmk_visium_glioblastoma_%A_%a.out
#SBATCH --error=/home/hpc_user/spatialge_stdiff_manuscript/stdiff_hpcrun_spamm/code/logs/error_hmk_visium_glioblastoma_%A_%a.err

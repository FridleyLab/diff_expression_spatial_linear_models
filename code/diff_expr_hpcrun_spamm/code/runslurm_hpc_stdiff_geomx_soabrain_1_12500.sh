...
#SBATCH --output=/home/4472525/spatialge_stdiff_manuscript/stdiff_hpcrun_spamm/code/logs/output_geomx_brain_%A_%a.out
#SBATCH --error=/home/4472525/spatialge_stdiff_manuscript/stdiff_hpcrun_spamm/code/logs/error_geomx_brain_%A_%a.err

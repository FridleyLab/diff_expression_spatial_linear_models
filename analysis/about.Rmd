...
This repository contains code to reproduce the figures in the manuscript entitled "Differential gene expression analysis of spatial transcriptomic experiments using spatial mixed models" ([Ospina et al. 2024](https://www.nature.com/articles/s41598-024-61758-0)). The contents of the repository are briefly detailed here:
